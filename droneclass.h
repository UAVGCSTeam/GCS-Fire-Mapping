...
public:
    ...
    */
    ...
    QVector3D getPosition() const { return QVector3D(m_marker->getPosition(),m_altitude); };
    ...
    double getLatitude() const {return m_marker->getLatitude(); }; //temporary
    //void setLatitude(const double latitude);          //temporary
    double getLongitude() const {return m_marker->getLongitude(); }; //temporary
    ...
    MarkerClass* getMarker() const {return m_marker;};
